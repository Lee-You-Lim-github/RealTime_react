  ...
  return (
    <div className="flex justify-center items-center">
      <div class="lg:w-2/5 md:w-1/2 w-2/3">
        <div class="bg-white border border-orange-400 rounded-lg shadow-xl mx-auto p-10 my-20">
          <h1 class="text-center text-3xl text-gray-800 mb-10">회원가입</h1>
          ...
          <React.Fragment>
            <div>
              <button
                className="text-white text-lg bg-orange-400 border-2 border-orange-400 w-full rounded p-1 mb-1 mt-6"
                onClick={openModal}
              >
                가입
              </button>
