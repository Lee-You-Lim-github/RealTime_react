        ...
        <section>
          ...
          <div className="flex justify-center mr-3 my-1">
            ...
            <button
              ...
              onClick={close}
              name="no"
              className="text-sm border-2 border-orange-300 hover:border-orange-300 hover:text-orange-300 text-orange-400 py-1 px-2 rounded focus:outline-none focus:shadow-outline"
            >
              취소
            </button>
          </div>
