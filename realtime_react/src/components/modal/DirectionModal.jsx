          ...
          <ShopCarousel show={1}>
            <div className="bg-gray-300">
              ...
              <div className="mt-4 mr-8 ml-[70px] h-[420px] w-[310px] bg-white border-2  rounded-tr-lg rounded-tl-lg">
                <div className="flex mt-6">
                  <div className="ml-2 mt-1 text-lg">엉클 까르보</div>
                  <div className="ml-3 border-2 border-violet-300 rounded">
                    지금예약
                  </div>
                  <div className="ml-3 border-2 border-violet-300 rounded">
                    지금말고 예약
                ...
                <div>잔여 테이블 수 7/12</div>
                <div>찜하기 ♡</div>
                <img className="w-96 h-48" src={category_cafe} />
                <div>먼저 원하는 매장에서 예약할 방법을 선택하세요</div>
                <div>지금 예약은 20분 안에 방문 때,</div>
                <div>지금 말고 예약은 다른 시간에 방문할 때 </div>
              </div>
            </div>
            ...
            <div className="bg-gray-300">
              ...
              <div className="mt-4 mr-8 ml-[70px] h-[420px] w-[310px] bg-white border-2  rounded-tr-lg rounded-tl-lg">
                ...
                <div className="mt-20">
                  원하시는 매장의 테이블 수를 선택하세요
                </div>
                <div className="mt-2 ml-1">테이블 기준 인원은 4인 입니다</div>
              </div>
            ...
            <div className="bg-gray-300">
              ...
              <div className="mt-4 mr-8 ml-[70px] h-[420px] w-[310px] bg-white border-2  rounded-tr-lg rounded-tl-lg">
                <div className="ml-3 mt-2">엉클 까르보</div>
                ...
                <div className="mt-4">
                  마이 페이지 예약 내역에서 예약 내역을 확인, 취소할 수 있습니다
                </div>
                <div>단, 지금 예약은 5분 이내만 가능합니다</div>
              </div>
            </div>
            ...
            <div className="bg-gray-300">
              ...
              <div className="mt-4 mr-8 ml-[70px] h-[420px] w-[310px] bg-white border-2  rounded-tr-lg rounded-tl-lg">
                ...
                <div>찜하기 ♡</div>
                <img className="w-96 h-48" src={category_cafe} />
                <div>만석인 매장에서 줄서기를 할 수 있습니다</div>
              </div>
            </div>
            ...
            <div className="bg-gray-300">
              ...
              <div className="mt-4 mr-8 ml-[70px] h-[420px] w-[310px] bg-white border-2  rounded-tr-lg rounded-tl-lg">
                <img className="w-96 h-48" src={category_cafe} />
                <div>대기 순서는 홈 화면 하단에서 확인할 수 있습니다</div>
              </div>
            </div>
          </ShopCarousel>
        </section>
